                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-403bdb5a593791cd5accce5df5f3a00c"' : 'data-target="#xs-components-links-module-AppModule-403bdb5a593791cd5accce5df5f3a00c"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-403bdb5a593791cd5accce5df5f3a00c"' :
                                            'id="xs-components-links-module-AppModule-403bdb5a593791cd5accce5df5f3a00c"' }>
                                            <li class="link">
